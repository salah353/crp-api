using crp_api.Repositories;
using crp_api.Services;
using crp_api.Services.Bsc;
using crp_api.Services.Sol;
using crp_api.Services.Sui;
...
// Configuration
builder.Services.Configure<GlobalBlockchainConfig>(
